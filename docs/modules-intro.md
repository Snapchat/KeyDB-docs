...
* `INTRO.md` (this file). An overview about KeyDB Modules system and API. It's a good idea to start your reading here.
...
a first citizen of the KeyDB executable. On the contrar, the method
