module.exports = {
	"docs": [
		...
		{type: 'category', label: 'Server Infrastructure', items: ["active-rep", "multi-master", "replication", "cluster-spec", "cluster-man", "cluster-create", "cluster-tutorial", "sentinel", "sentinel-clients", "mvcc"]},
		...
		{type: 'category', label: 'Configuration', collapsed: true, items: ["flash", "flash-sizing", "persistence", "client-side-caching","lru-cache", "config-file"]},
